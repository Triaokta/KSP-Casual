                    ...
                    <form action="{{ route('attendance.update', $attendance->id) }}" method="POST">
                        ...
                        <div class="row g-3 mb-4">
                            <div class="col-md-6">
                                ...
                                <input type="time" class="form-control" id="time_in" name="time_in" value="{{ old('time_in', $attendance->time_in) }}" required>
                            </div>

                            <div class="col-md-6">
                                <label for="time_out" class="form-label">Jam Keluar</label>
                                <input type="time" class="form-control" id="time_out" name="time_out" value="{{ old('time_out', $attendance->time_out) }}">
