...
<div class="mb-3">
    ...
    <input type="text" class="form-control" id="nik_ktp" name="nik_ktp" value="{{ old('nik_ktp', $employee->nik_ktp ?? '') }}" required>
</div>
<div class="mb-3">
...
<div class="mb-3">
    ...
    <input type="text" class="form-control" id="no_kk" name="no_kk" value="{{ old('no_kk', $employee->no_kk ?? '') }}">
</div>
<div class="mb-3">
    <label for="department_id" class="form-label">Departemen / Divisi</label>
    <select class="form-select" id="department_id" name="department_id" required>
        <option value="" disabled selected>Pilih Departemen...</option>
        {{-- Loop untuk menampilkan semua departemen dari database --}}
...
<div class="mb-3">
    ...
    <select class="form-select" id="is_active" name="is_active" required>
        {{-- 
            Logika ini akan otomatis memilih 'Aktif' saat membuat data baru,
            dan memilih status yang sesuai saat mengedit data.
        --}}
